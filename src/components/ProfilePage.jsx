    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <h1 className="text-xl font-bold text-purple-600">GameZone</h1>
      ...
      <main className="container mx-auto px-4 py-6">
          ...
          <div className="p-6">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="flex flex-col items-center">
                <div className="h-24 w-24 rounded-full border-2 border-purple-500 overflow-hidden shadow-md">
                  <img
                ...
                <span className="mt-2 px-2 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-purple-600 to-indigo-500 text-white shadow-sm">
                  Pro Player
                </span>
              </div>

              <div className="flex-1 text-center md:text-left">
                <h2 className="text-2xl font-bold text-gray-800">GamerX123</h2>
                <div className="text-gray-500 flex flex-col md:flex-row md:items-center gap-1 md:gap-4 mt-1">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 text-center shadow-sm">
                    ...
                    <p className="text-xl font-bold text-green-500">156</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3 text-center shadow-sm">
        ...
        <div className="w-full">
          {/* Tabs Header */}
          <div className="grid grid-cols-4 md:grid-cols-7 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            {[
              ...
              <button
                ...
                className={`flex items-center justify-center py-3 px-3 text-sm font-medium transition-colors ${
                  activeTab === tab.id
          ...
          <div className="mt-6">
            ...
            {activeTab === "games" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  <h2 className="text-xl font-bold text-gray-800">My Games</h2>
                  <p className="text-gray-500 text-sm">View your recent match history</p>
                </div>
                <div className="p-4">
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">{game.game}</p>
                            <p className="text-sm text-gray-500">{game.date}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className={`font-medium ${game.status === "win" ? "text-green-500" : "text-red-500"}`}>
                            {game.result}
                          </p>
                          <p className={`text-sm ${game.status === "win" ? "text-green-500" : "text-red-500"}`}>
                            {game.amount}
                          </p>
                        </div>
                      </div>
                  ...
                  <button className="w-full mt-4 py-2 px-4 border border-purple-200 rounded-md text-purple-600 hover:text-purple-700 hover:bg-purple-50 transition-colors">
                    View All Games
                  </button>
                </div>
              </div>
                ...
                <div className="p-4">
                  <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-6 mb-6 border border-purple-100">
                    <div className="flex flex-col items-center text-center">
                      <Gift className="h-12 w-12 text-amber-500 mb-3" />
                      <h3 className="text-xl font-bold mb-2 text-gray-800">Invite Friends & Earn ₹100</h3>
                      <p className="text-gray-600 mb-4">For each friend who joins and plays their first game</p>

                      <div className="w-full max-w-md bg-white rounded-lg p-3 flex items-center justify-between mb-4 shadow-sm border border-gray-100">
                        <code className="text-amber-600 font-mono">GAMERX123FRIEND</code>
                      ...
                      <div className="grid grid-cols-2 gap-3 w-full max-w-md">
                        <button className="py-2 px-4 bg-green-500 hover:bg-green-600 rounded-md text-white transition-colors shadow-sm">
                          Share on WhatsApp
                        </button>
                        <button className="py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors shadow-sm">
                          Copy Link
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg text-gray-800">Your Referrals</h3>
                        ...
                        <div className="text-right">
                          <p
                            className={`font-medium ${
                              referral.status === "Completed" ? "text-green-500" : "text-amber-500"
                            }`}
                          >
                            {referral.status}
                          </p>
            ...
            {activeTab === "withdrawals" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  <h2 className="text-xl font-bold text-gray-800">My Withdrawals</h2>
                  <p className="text-gray-500 text-sm">Track your withdrawal history</p>
                </div>
                <div className="p-4">
                  <div className="bg-gray-50 rounded-lg p-4 mb-6 flex flex-col sm:flex-row items-center justify-between shadow-sm">
                    <div>
                      <p className="text-gray-600 mb-1">Available Balance</p>
                      <p className="text-2xl font-bold text-amber-500">₹2,450</p>
                    </div>
                    <button className="mt-3 sm:mt-0 py-2 px-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-md text-white transition-colors shadow-sm">
                      Withdraw Funds
                    </button>
                  </div>

                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg text-gray-800">Recent Withdrawals</h3>
            ...
            {activeTab === "kyc" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  ...
                  <p className="text-gray-500 text-sm">Verify your identity to unlock all features</p>
                </div>
                <div className="p-4">
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 rounded-lg p-6 mb-6">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mb-3 shadow-sm">
                        <Shield className="h-8 w-8 text-green-500" />
                      </div>
                      <h3 className="text-xl font-bold mb-2 text-green-600">Verification Complete</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg text-gray-800">Verification Details</h3>

                    <div className="grid gap-4">
                      <div className="flex justify-between p-3 bg-gray-50 rounded-lg shadow-sm">
                      ...
                      <div className="flex justify-between p-3 bg-gray-50 rounded-lg shadow-sm">
                        <p className="text-gray-600">Address Verification</p>
                        <span className="px-2 py-1 text-xs font-semibold rounded-full bg-green-500 text-white">
                          Verified
                        </span>
                      </div>
                      <div className="flex justify-between p-3 bg-gray-50 rounded-lg shadow-sm">
                        <p className="text-gray-600">Phone Verification</p>
                        <span className="px-2 py-1 text-xs font-semibold rounded-full bg-green-500 text-white">
                          Verified
                        </span>
                      </div>
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg shadow-sm">
                    ...
                    <button className="text-purple-600 underline mt-1 text-sm">Contact Support</button>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === "settings" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="p-4 space-y-6">
                  <div>
                    <h3 className="text-lg font-medium mb-4 text-gray-800">Notification Settings</h3>
                    <div className="space-y-4">
                      {[
                        {
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-4">
                      <Link
                        to="#"
                        className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-purple-50 shadow-sm"
                      >
                        <div className="flex items-center gap-3">
                          <User className="h-5 w-5 text-purple-600" />
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <button className="w-full py-2 px-4 bg-red-500 hover:bg-red-600 rounded-md text-white transition-colors shadow-sm flex items-center justify-center gap-2">
            ...
            {activeTab === "support" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  <h2 className="text-xl font-bold text-gray-800">Support & FAQs</h2>
                  <p className="text-gray-500 text-sm">Get help and find answers to common questions</p>
                </div>
                <div className="p-4">
                  <div className="grid gap-6">
                    <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button className="py-2 px-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-md text-white transition-colors shadow-sm">
                          Contact Support
                        </button>
                        <button className="py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-100 transition-colors shadow-sm">
                          Live Chat
                        </button>
                      </div>
                    </div>
                    ...
                    <div>
                      <h3 className="font-semibold text-lg mb-3 text-gray-800">Frequently Asked Questions</h3>
                      <div className="space-y-2 bg-white rounded-lg shadow-sm border border-gray-200 divide-y divide-gray-200">
                        {[
                          {
                            id: "item-1",
                          ...
                          <div key={item.id} className="px-4">
                            <button
                              ...
                              className="flex w-full items-center justify-between py-3 text-left font-medium text-gray-800 hover:text-purple-600 transition-colors"
                            >
                              {item.question}
                              <ChevronDown
                            ...
                            {openAccordion === item.id && (
                              <div className="pb-3 text-gray-600 text-sm">{item.answer}</div>
                            )}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="grid gap-4">
                      <h3 className="font-semibold text-lg text-gray-800">Helpful Resources</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <Link
                          to="#"
                          className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg hover:bg-purple-50 shadow-sm"
                        >
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Platform policies</p>
                          </div>
                        </Link>
                        <Link
                          to="#"
                        ...
                        >
                          ...
                          <div>
                            <p className="font-medium text-gray-800">Responsible Gaming</p>
                            <p className="text-sm text-gray-500">Play safely</p>
                          </div>
                        </Link>
                        <Link
                          to="#"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Visual guides</p>
                          </div>
                        </Link>
                      </div>
                    </div>
            ...
            {activeTab === "account" && (
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div className="p-4 border-b border-gray-100">
                  ...
                  <p className="text-gray-500 text-sm">View and update your account details</p>
                </div>
                <div className="p-4">
                  <div className="space-y-6">
                    <div className="grid gap-4">
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                        <div>
                          ...
                          <p className="text-gray-800">GamerX123</p>
                        </div>
                        <button className="text-purple-600 hover:text-purple-700 p-2">Edit</button>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                        <div>
                          <p className="text-sm text-gray-500">Email</p>
                          <p className="text-gray-800">gamer.x123@example.com</p>
                        </div>
                        <button className="text-purple-600 hover:text-purple-700 p-2">Edit</button>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                      ...
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                        <div>
                          ...
                          <p className="text-gray-800">15 Jan 1995</p>
                        </div>
                        <button className="text-purple-600 hover:text-purple-700 p-2">Edit</button>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                          ...
                          <button className="py-1 px-3 text-sm border border-gray-300 rounded-md hover:bg-gray-100 transition-colors">
                            Update
                          </button>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <h3 className="font-semibold text-lg mb-4 text-gray-800">Linked Accounts</h3>
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg shadow-sm">
                          <div className="flex items-center gap-3">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <button className="w-full py-2 px-4 bg-red-500 hover:bg-red-600 rounded-md text-white transition-colors shadow-sm">
                        Delete Account
                      </button>
