...
export default function TagPeopleModal({ users, setShowTagPeople }) {
            ...
            {taggedPeople.length > 0 ? (
              <div className="space-y-2">
                {taggedPeople.map((user) => (
                  <div key={user.id} className="flex items-center justify-between py-2 px-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center space-x-3">
