...
import ClassicMode from "./game-modes-carrom/ClassicMode"
import TournamentMode from "./game-modes-carrom/TournamentMode"
import QuickMode from "./game-modes-carrom/QuickMode"
import PrivateMode from "./game-modes-carrom/PrivateMode"
          ...
          <div className="relative w-full h-screen bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col min-h-screen px-4">
              ...
              <div className="text-center mb-4">
                ...
                <h1 className="text-3xl font-bold tracking-tight">Carrom</h1>
