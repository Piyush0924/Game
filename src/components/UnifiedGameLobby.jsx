...
import { ChevronLeft, Users, Clock, Trophy, Gamepad, Star, Heart, Zap, Info, Target, Brain } from "lucide-react";
...
const UnifiedGameLobby = ({
  ...
  // Extract game information from URL params
  const gameId = params.gameId || "memorymatch";
  const gameMode = params.mode || "classic";
  const entryFee = parseInt(searchParams.get("price") || "10");
  ...
  const getGameTitle = () => {
    ...
    if (gameId.toLowerCase() === "stonepaper") return "Stone Paper Scissors";
      ...
      default:
        return (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <p className="text-white/70">Preparing your game experience</p>
          </div>
        );
    }
  };
    ...
    <div className="fixed inset-0 flex items-center justify-center">
      ...
      <div className="absolute top-0 left-0 w-full z-20 p-4 flex justify-between items-center">
        ...
        <div className="text-white font-medium">
          {getGameTitle()} - {gameMode.charAt(0).toUpperCase() + gameMode.slice(1)} Mode
        </div>
...
export default UnifiedGameLobby; 